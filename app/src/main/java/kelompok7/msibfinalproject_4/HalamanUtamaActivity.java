...
public class HalamanUtamaActivity extends AppCompatActivity {
    ...
    private ImageView ivProfile, ivSearch, ivNote, ivNotification, ivprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivprofile = findViewById(R.id.ivPerson);

        ivSearch.setOnClickListener(v -> {
            startActivity(new Intent(this, MainActivity.class));
            finish();
        });
        ivNote.setOnClickListener(v -> {
            startActivity(new Intent(this, HalamanUtamaActivity.class));
            finish();
        });
        ivNotification.setOnClickListener(v -> {
            startActivity(new Intent(this, Soon.class));
            finish();
        });
